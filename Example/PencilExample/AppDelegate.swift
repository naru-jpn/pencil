...
//        let num: Int = 10
//        debugPrint("|||||||||||||| \(String.value(from: num.data))")
//        
//        let array: [Int] = [5, 6]
////        debugPrint("|||||||||||||||||||||||||| \([Int].value(from: array.data))")
//        
//        debugPrint("head: \(array.pencilHead)")
//        debugPrint("body: \(array.pencilBody)")
        
        
        let sample: Sample = Sample(dictionary: ["key1": 2, "key2": 3], array: [5, 6, 103], identifier: "identifier of sample")

        let data: NSData = sample.data
